// ** React Imports
import { ChangeEvent, MouseEvent, useState, forwardRef, useEffect } from 'react'
...
import { createUser, getAllGender } from 'src/main/services/UserManagement'
...
const CreateUserPage = () => {
  ...
  async function handleSubmit(e:any): Promise<void>{
    ...
    const response = await createUser(fullname, username, email, values.password, phone, dateOfBirth, gender, address, emplNumb, specialist, administrativeStructure)
              ...
              <Grid item xs={12} sm={9}>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Button variant='contained' onClick={() => handleAddAdministrativeStructure() } color='primary' sx={{margin: '5px'}}>
                      Add Administrative Structure
                    </Button>
                  </Box>
                </Box>
              </Grid>
